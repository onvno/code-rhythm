...
面对各种效率问题，就提出一个问题，代码补全仅仅就是一个提示说明，也许作为一个为了提高效率的懒人，我们需要的是：直接给我使用demo,改一下不就ok了？

Bingo，代码片段 + demo的小工具，让写代码更带感，code-rhythm!
...
目前测试vscode的禁用插件功能可能由于异步机制存在问题，不一定能正确执行对应的禁用操作，所以建议直接卸载。
